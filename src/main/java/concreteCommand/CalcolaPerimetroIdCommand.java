...
public class CalcolaPerimetroIdCommand implements Command{
    private LinkedList<GraphicObject> oggetti;
    private String tipo;
    private JTextArea visualizzazione;

    public CalcolaPerimetroIdCommand(PannelloGrafico panel, JTextArea visualizzazione, String tipo){
        this.tipo=tipo;
    ...
    public boolean doIt() {
        ...
        visualizzazione.setText("Perimetro di "+tipo+":"+"\n");
